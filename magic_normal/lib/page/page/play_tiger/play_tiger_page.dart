...
import 'package:magic_normal/page/page/play_tiger/play_tiger_controller.dart';
...
class PlayTigerPage extends SmBasePage<PlayTigerController>{
  @override
  String backgroundName() => "tiger_bg";

  @override
  PlayTigerController setController() => PlayTigerController();
        ...
        Column(
          ...
          children: [
            ...
            Container(
              ...
              child: GetBuilder<PlayTigerController>(
                id: "prize_list",
      ...
      child: SizedBox(
        ...
        child: Stack(
          ...
          children: [
            ...
            GetBuilder<PlayTigerController>(
              id: "result_fail",
  ...
  _goldWidget()=>GetBuilder<PlayTigerController>(
    id: "gold_icon",
    builder: (_){
