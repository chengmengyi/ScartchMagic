...
import 'package:magic_normal/page/page/play_7/play7_bean.dart';
...
class Play7Controller extends SmBaseController{
  ...
  _initYourNumList(){
    yourList.clear();
    var play7reward = NormalValueHep.instance.getPlay7Reward();
    if(NormalValueHep.instance.getPlay7Chance()){
      yourList.add(Play7Bean(icon: "play_one_7", num: 0, reward: play7reward));
    }
    if(NormalValueHep.instance.getPlay77Chance()){
