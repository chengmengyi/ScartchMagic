...
import 'package:magic_normal/page/page/play_8/play8_bean.dart';
...
class Play8Controller extends SmBaseController{
  ...
  _initYourList(){
    yourList.clear();
    if(NormalValueHep.instance.getPlay8Chance()){
      yourList.add(Play8Bean(icon: "play87", reward: NormalValueHep.instance.getPlay8Reward(), is8: true));
    }
    if(NormalValueHep.instance.getPlay8IconChance()){
      var icon = _otherIconList.random();
      for(int index=0; index<3;index++){
        yourList.add(Play8Bean(icon: icon, reward: NormalValueHep.instance.getPlay8Reward(), is8: false));
      }
    }
